...
```text
TypeSpec @sample → Emitter → Test Files
```
...
:::caution
Test files matching `test_load_*.py`, `*ConversionTests.cs`, or `*.test.ts` patterns ARE regenerated. Add custom tests with different naming patterns.
:::
