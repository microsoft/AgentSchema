...
3. **Runtime libraries** are auto-generated (C#, Python, TypeScript, Go, Rust)
...
flowchart TD
    ...
    B --> I[Rust Runtime<br/>runtime/rust/]
...
- agentschema-emitter/ **Self-contained emitter package**
  - lib/model/ **Edit these** (source of truth)
    - main.tsp
    - agent.tsp
    - tools.tsp
    - …
  - src/ **Or edit templates here**
  - src/
    - templates/
