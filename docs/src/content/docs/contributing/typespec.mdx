...
| TypeSpec | C# | Python | TypeScript | Go | Rust |
|----------|-----|--------|------------|----|----|
| `string` | `string` | `str` | `string` | `string` | `String` |
| `int32` | `int` | `int` | `number` | `int32` | `i32` |
| `int64` | `long` | `int` | `number` | `int64` | `i64` |
| `float32` | `float` | `float` | `number` | `float32` | `f32` |
| `float64` | `double` | `float` | `number` | `float64` | `f64` |
| `boolean` | `bool` | `bool` | `boolean` | `bool` | `bool` |
| `string[]` | `IList<string>` | `list[str]` | `string[]` | `[]string` | `Vec<String>` |
| `Record<unknown>` | `IDictionary<string, object>` | `dict[str, Any]` | `Record<string, unknown>` | `map[string]any` | `HashMap<String, serde_json::Value>` |
...
cd ../../rust/agentschema && cargo test
```
