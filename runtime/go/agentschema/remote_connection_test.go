...
// TestRemoteConnectionRoundtripYAML tests YAML load -> save -> load produces equivalent data
func TestRemoteConnectionRoundtripYAML(t *testing.T) {
	yamlData := `
kind: remote
name: my-reference-connection
endpoint: https://{your-custom-endpoint}.openai.azure.com/
...
// TestRemoteConnectionLoadFromMap tests loading RemoteConnection from an empty map
func TestRemoteConnectionLoadFromMap(t *testing.T) {
	data := make(map[string]interface{})
	ctx := agentschema.NewLoadContext()
	instance, err := agentschema.LoadRemoteConnection(data, ctx)
	if err != nil {
		t.Fatalf("Failed to load RemoteConnection from map: %v", err)
	}
	_ = instance // Load succeeded
}

// TestRemoteConnectionSaveToMap tests saving RemoteConnection to a map
func TestRemoteConnectionSaveToMap(t *testing.T) {
	instance := agentschema.RemoteConnection{}
