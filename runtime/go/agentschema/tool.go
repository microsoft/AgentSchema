	...
	if m, ok := data.(map[string]interface{}); ok {
		...
		if val, ok := m["parameters"]; ok && val != nil {
			if m, ok := val.(map[string]interface{}); ok {
				loaded, _ := LoadPropertySchema(m, ctx)result.Parameters = loaded}
		}
		if val, ok := m["strict"]; ok && val != nil {v := val.(bool)
			result.Strict = &v}
	}
...
func (obj *FunctionTool) Save(ctx *SaveContext) map[string]interface{} {
	...
	if obj.Strict != nil {result["strict"] = *obj.Strict}
...
func LoadCustomTool(data interface{}, ctx *LoadContext) (CustomTool, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		...
		if val, ok := m["connection"]; ok && val != nil {
			if m, ok := val.(map[string]interface{}); ok {
				loaded, _ := LoadConnection(m, ctx)result.Connection = loaded}
		}
...
func LoadFileSearchTool(data interface{}, ctx *LoadContext) (FileSearchTool, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		...
		if val, ok := m["maximumResultCount"]; ok && val != nil {v := val.(int32)
			result.Maximumresultcount = &v}
		if val, ok := m["ranker"]; ok && val != nil {v := val.(string)
			result.Ranker = &v}
		if val, ok := m["scoreThreshold"]; ok && val != nil {v := val.(float32)
...
func (obj *FileSearchTool) Save(ctx *SaveContext) map[string]interface{} {
	...
	if obj.Maximumresultcount != nil {result["maximumResultCount"] = *obj.Maximumresultcount}
	if obj.Ranker != nil {result["ranker"] = *obj.Ranker}
	if obj.Scorethreshold != nil {result["scoreThreshold"] = *obj.Scorethreshold}
	if obj.Filters != nil {
...
func LoadMcpTool(data interface{}, ctx *LoadContext) (McpTool, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		...
		if val, ok := m["serverName"]; ok && val != nil {result.Servername = val.(string)}
		if val, ok := m["serverDescription"]; ok && val != nil {v := val.(string)
			result.Serverdescription = &v}
		if val, ok := m["approvalMode"]; ok && val != nil {
			if m, ok := val.(map[string]interface{}); ok {
				loaded, _ := LoadMcpServerApprovalMode(m, ctx)result.Approvalmode = loaded}
		}
...
func (obj *McpTool) Save(ctx *SaveContext) map[string]interface{} {
	...
	if obj.Serverdescription != nil {result["serverDescription"] = *obj.Serverdescription}
...
func LoadOpenApiTool(data interface{}, ctx *LoadContext) (OpenApiTool, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		...
		if val, ok := m["specification"]; ok && val != nil {result.Specification = val.(string)}
	}
