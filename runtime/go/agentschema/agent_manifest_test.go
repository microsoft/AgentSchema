...
// TestAgentManifestRoundtripYAML tests YAML load -> save -> load produces equivalent data
func TestAgentManifestRoundtripYAML(t *testing.T) {
	yamlData := `
name: basic-prompt
displayName: My Basic Prompt
description: A basic prompt that uses the GPT-3 chat API to answer questions
...
// TestAgentManifestRoundtripYAML1 tests YAML load -> save -> load produces equivalent data
func TestAgentManifestRoundtripYAML1(t *testing.T) {
	yamlData := `
name: basic-prompt
displayName: My Basic Prompt
description: A basic prompt that uses the GPT-3 chat API to answer questions
...
// TestAgentManifestLoadFromMap tests loading AgentManifest from an empty map
func TestAgentManifestLoadFromMap(t *testing.T) {
	data := make(map[string]interface{})
	ctx := agentschema.NewLoadContext()
	instance, err := agentschema.LoadAgentManifest(data, ctx)
	if err != nil {
		t.Fatalf("Failed to load AgentManifest from map: %v", err)
	}
	_ = instance // Load succeeded
}

// TestAgentManifestSaveToMap tests saving AgentManifest to a map
func TestAgentManifestSaveToMap(t *testing.T) {
	instance := agentschema.AgentManifest{}
