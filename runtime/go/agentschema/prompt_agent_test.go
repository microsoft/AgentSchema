...
// TestPromptAgentRoundtripYAML tests YAML load -> save -> load produces equivalent data
func TestPromptAgentRoundtripYAML(t *testing.T) {
	yamlData := `
kind: prompt
model:
  id: gpt-35-turbo
...
// TestPromptAgentRoundtripYAML1 tests YAML load -> save -> load produces equivalent data
func TestPromptAgentRoundtripYAML1(t *testing.T) {
	yamlData := `
kind: prompt
model:
  id: gpt-35-turbo
...
// TestPromptAgentLoadFromMap tests loading PromptAgent from an empty map
func TestPromptAgentLoadFromMap(t *testing.T) {
	data := make(map[string]interface{})
	ctx := agentschema.NewLoadContext()
	instance, err := agentschema.LoadPromptAgent(data, ctx)
	if err != nil {
		t.Fatalf("Failed to load PromptAgent from map: %v", err)
	}
	_ = instance // Load succeeded
}

// TestPromptAgentSaveToMap tests saving PromptAgent to a map
func TestPromptAgentSaveToMap(t *testing.T) {
	instance := agentschema.PromptAgent{}
