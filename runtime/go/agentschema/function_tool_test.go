...
// TestFunctionToolRoundtripYAML tests YAML load -> save -> load produces equivalent data
func TestFunctionToolRoundtripYAML(t *testing.T) {
	yamlData := `
kind: function
parameters:
  properties:
...
// TestFunctionToolRoundtripYAML1 tests YAML load -> save -> load produces equivalent data
func TestFunctionToolRoundtripYAML1(t *testing.T) {
	yamlData := `
kind: function
parameters:
  properties:
...
// TestFunctionToolLoadFromMap tests loading FunctionTool from an empty map
func TestFunctionToolLoadFromMap(t *testing.T) {
	data := make(map[string]interface{})
	ctx := agentschema.NewLoadContext()
	instance, err := agentschema.LoadFunctionTool(data, ctx)
	if err != nil {
		t.Fatalf("Failed to load FunctionTool from map: %v", err)
	}
	_ = instance // Load succeeded
}

// TestFunctionToolSaveToMap tests saving FunctionTool to a map
func TestFunctionToolSaveToMap(t *testing.T) {
	instance := agentschema.FunctionTool{}
