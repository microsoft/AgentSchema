...
func LoadConnection(data interface{}, ctx *LoadContext) (Connection, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		...
		if val, ok := m["authenticationMode"]; ok && val != nil {result.Authenticationmode = val.(string)}
		if val, ok := m["usageDescription"]; ok && val != nil {v := val.(string)
...
func (obj *Connection) Save(ctx *SaveContext) map[string]interface{} {
	...
	if obj.Usagedescription != nil {result["usageDescription"] = *obj.Usagedescription}
...
func LoadReferenceConnection(data interface{}, ctx *LoadContext) (ReferenceConnection, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		...
		if val, ok := m["target"]; ok && val != nil {v := val.(string)
			result.Target = &v}
	}
...
func (obj *ReferenceConnection) Save(ctx *SaveContext) map[string]interface{} {
	...
	if obj.Target != nil {result["target"] = *obj.Target}
...
func LoadRemoteConnection(data interface{}, ctx *LoadContext) (RemoteConnection, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		if val, ok := m["kind"]; ok && val != nil {result.Kind = val.(string)}
		if val, ok := m["name"]; ok && val != nil {result.Name = val.(string)}
		if val, ok := m["endpoint"]; ok && val != nil {result.Endpoint = val.(string)}
	}
...
func LoadApiKeyConnection(data interface{}, ctx *LoadContext) (ApiKeyConnection, error) {
	...
	if m, ok := data.(map[string]interface{}); ok {
		if val, ok := m["kind"]; ok && val != nil {result.Kind = val.(string)}
		if val, ok := m["endpoint"]; ok && val != nil {result.Endpoint = val.(string)}
		if val, ok := m["apiKey"]; ok && val != nil {result.Apikey = val.(string)}
	}
