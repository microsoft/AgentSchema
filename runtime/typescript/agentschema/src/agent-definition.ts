...
export class ContainerAgent extends AgentDefinition {
  ...
  constructor(init?: Partial<ContainerAgent>) {
    ...
    if (init?.codeConfiguration !== undefined) {
      this.codeConfiguration = init.codeConfiguration;
    }
  }
  ...
  static load(data: Record<string, unknown>, context?: LoadContext): ContainerAgent {
    ...
    if (data["codeConfiguration"] !== undefined && data["codeConfiguration"] !== null) {
      instance.codeConfiguration = CodeConfiguration.load(
        data["codeConfiguration"] as Record<string, unknown>,
        context
      );
    }
  ...
  save(context?: SaveContext): Record<string, unknown> {
    ...
    if (obj.codeConfiguration !== undefined && obj.codeConfiguration !== null) {
