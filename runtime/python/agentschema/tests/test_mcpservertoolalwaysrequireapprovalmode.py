...
def test_roundtrip_yaml_mcpservertoolalwaysrequireapprovalmode():
...
def test_load_mcpservertoolalwaysrequireapprovalmode_from_dict():
...
def test_save_mcpservertoolalwaysrequireapprovalmode_to_dict():
