...
def test_roundtrip_yaml_agentdefinition():
...
def test_roundtrip_yaml_agentdefinition_1():
    """Test that YAML load -> save -> load produces equivalent data."""
    yaml_data = """
    kind: prompt
    name: basic-prompt
...
def test_roundtrip_yaml_agentdefinition_2():
    """Test that YAML load -> save -> load produces equivalent data."""
    yaml_data = """
    kind: prompt
    name: basic-prompt
...
def test_roundtrip_yaml_agentdefinition_3():
    """Test that YAML load -> save -> load produces equivalent data."""
    yaml_data = """
    kind: prompt
    name: basic-prompt
