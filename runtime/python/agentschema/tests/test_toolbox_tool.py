...
def test_load_json_toolboxtool():
    ...
    assert instance.id == "web_search"
    assert instance.name == "my-search-tool"
    assert instance.description == "Searches the web for up-to-date information"
...
def test_roundtrip_json_toolboxtool():
    ...
    assert reloaded.id == "web_search"
    assert reloaded.name == "my-search-tool"
    assert reloaded.description == "Searches the web for up-to-date information"
