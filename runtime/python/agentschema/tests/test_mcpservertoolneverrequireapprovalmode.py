...
def test_roundtrip_yaml_mcpservertoolneverrequireapprovalmode():
...
def test_load_mcpservertoolneverrequireapprovalmode_from_dict():
...
def test_save_mcpservertoolneverrequireapprovalmode_to_dict():
