...
/// Represents a tool definition within a toolbox. Tools can be Foundry-hosted (bing_grounding, azure_ai_search, etc.) or external (mcp, openapi) with connection details.
