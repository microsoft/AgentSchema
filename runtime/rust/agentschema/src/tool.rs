...
impl FileSearchTool {
    ...
    pub fn load_from_value(value: &serde_json::Value) -> Self {
        Self {
            kind: value.get("kind").and_then(|v| v.as_str()).unwrap_or_default().to_string(),
            connection: value.get("connection").cloned().unwrap_or(serde_json::Value::Null),
            vector_store_ids: value.get("vectorStoreIds").and_then(|v| v.as_array()).map(|arr| arr.iter().filter_map(|v| v.as_str().map(|s| s.to_string())).collect()).unwrap_or_default(),
            maximum_result_count: value.get("maximumResultCount").and_then(|v| v.as_i64()).map(|n| n as i32),
            ranker: value.get("ranker").and_then(|v| v.as_str()).map(|s| s.to_string()),
            score_threshold: value.get("scoreThreshold").and_then(|v| v.as_f64()).map(|n| n as f32),
            filters: value.get("filters").cloned().unwrap_or(serde_json::Value::Null),
        }
    }
    ...
    pub fn to_value(&self) -> serde_json::Value {
        ...
        if !self.vector_store_ids.is_empty() {
            result.insert("vectorStoreIds".to_string(), serde_json::to_value(&self.vector_store_ids).unwrap_or(serde_json::Value::Null));
        }
        if let Some(ref val) = self.maximum_result_count {
            result.insert("maximumResultCount".to_string(), serde_json::to_value(val).unwrap_or(serde_json::Value::Null));
        }
        ...
        if let Some(ref val) = self.score_threshold {
            result.insert("scoreThreshold".to_string(), serde_json::to_value(val).unwrap_or(serde_json::Value::Null));
        }
...
impl McpTool {
    ...
    pub fn load_from_value(value: &serde_json::Value) -> Self {
        Self {
            ...
            approval_mode: value.get("approvalMode").cloned().unwrap_or(serde_json::Value::Null),
...
impl CodeInterpreterTool {
    ...
    pub fn load_from_value(value: &serde_json::Value) -> Self {
        Self {
            kind: value.get("kind").and_then(|v| v.as_str()).unwrap_or_default().to_string(),
            file_ids: value.get("fileIds").and_then(|v| v.as_array()).map(|arr| arr.iter().filter_map(|v| v.as_str().map(|s| s.to_string())).collect()).unwrap_or_default(),
        }
    }
    ...
    pub fn to_value(&self) -> serde_json::Value {
        ...
        if !self.file_ids.is_empty() {
            result.insert("fileIds".to_string(), serde_json::to_value(&self.file_ids).unwrap_or(serde_json::Value::Null));
        }
        serde_json::Value::Object(result)
    }
