...
"####;
    ...
    assert!(instance.maximum_result_count.is_some(), "Expected maximum_result_count to be Some");
    ...
    assert!(instance.score_threshold.is_some(), "Expected score_threshold to be Some");
