...
#pragma warning restore CS8618
    ...
    /// <returns>The loaded ModelResource instance.</returns>
    public new static ModelResource Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ModelResource instance.</returns>
    public new static ModelResource FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ModelResource instance.</returns>
    public new static ModelResource FromYaml(string yaml, LoadContext? context = null)
    {
