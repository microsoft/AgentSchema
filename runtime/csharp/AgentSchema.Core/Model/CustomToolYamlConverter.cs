...
public class CustomToolYamlConverter: YamlConverter<CustomTool>
{
    ...
    /// </summary>
    public static readonly CustomToolYamlConverter Instance = new CustomToolYamlConverter();
        ...
        while (!parser.TryConsume<MappingEnd>(out _))
        {
            ...
            switch (propertyName)
            {
                ...
                case "options":
                    ...
                    break;
                default:
                    throw new YamlException($"Unknown property '{propertyName}' in CustomTool.");
            }
        }
    ...
    public override void Write(IEmitter emitter, CustomTool value, ObjectSerializer serializer)
    {
