...
#pragma warning restore CS8618
    ...
    /// <returns>The loaded WebSearchTool instance.</returns>
    public new static WebSearchTool Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded WebSearchTool instance.</returns>
    public new static WebSearchTool FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded WebSearchTool instance.</returns>
    public new static WebSearchTool FromYaml(string yaml, LoadContext? context = null)
    {
