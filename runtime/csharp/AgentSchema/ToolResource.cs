...
#pragma warning restore CS8618
    ...
    /// <returns>The loaded ToolResource instance.</returns>
    public new static ToolResource Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolResource instance.</returns>
    public new static ToolResource FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolResource instance.</returns>
    public new static ToolResource FromYaml(string yaml, LoadContext? context = null)
    {
